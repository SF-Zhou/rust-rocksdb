...
use sfzhou_rocksdb::{TransactionDB, TransactionDBOptions};
use util::DBPath;
...
use sfzhou_rocksdb::MultiThreaded;
#[cfg(not(feature = "multi-threaded-cf"))]
use sfzhou_rocksdb::SingleThreaded;
...
fn test_no_leaked_column_family() {
    let n = DBPath::new("_rust_rocksdb_no_leaked_column_family");
    {
        ...
        let mut write_options = sfzhou_rocksdb::WriteOptions::default();
        ...
        for cf_index in 0..20 {
            ...
            let mut batch = sfzhou_rocksdb::WriteBatch::default();
